...
public class Conditions {
    public static void main(String[] args) {
        ...
        if(nr >= 0 && nr <= 5){
            System.out.println("Your username is too short. It must have, between 6 and 10 chart");

        } else if (nr >= 6 && nr<= 10) {
            System.out.println("Welcome" + user);
        } else {
            System.out.println("Your username is too long. It must have, between 6 and 10 chart" + user);
        }
        */
